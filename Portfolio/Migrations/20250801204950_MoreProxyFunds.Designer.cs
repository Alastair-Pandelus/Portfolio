...
namespace Portfolio.Migrations
{
    ...
    [Migration("20250801204950_MoreProxyFunds")]
    partial class MoreProxyFunds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.EntityModel.InstrumentMonthlyDelta", b =>
                {
                    ...
                    b.ToView("InstrumentMonthlyDelta", (string)null);
                });
            ...
            modelBuilder.Entity("Portfolio.EntityModel.ProxyInstrument", b =>
                {
                    b.HasOne("Portfolio.EntityModel.Instrument", "Proxy")
                        .WithMany("Proxies")
                        .HasForeignKey("InstrumentId")
